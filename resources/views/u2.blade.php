...
<head>
	...
	<title> Bluza World of Tanks </title>
...
@if (Route::has('login'))
		...
		<main>
			<h2>Bluza World of Tanks</h2>
			<article>
				<section>
					<div id="images">
						<a href="img/sklep14.jpg" target="_blank" data-lightbox="Obraz1" >
							<img class="gallery" id="zdj" src="img/sklep14.jpg" alt="zdjecie1" />
						</a>
					</div>
				</section>
				<section>
					<div id="details">
						...
						<li>Kolor podstawowy: szary / czarny</li>
						<li>Wyściełany materiał na piersi i ramionach</li>
						<li> Sznury z metalowymi zakończeniami</li>
						</ul>
						<h4>Rozmiar</h4>
						...
						<div id="akcja">
							<button onclick="dodajU('bluza,WoT',239)">Dodaj do koszyka</button>
							<button onclick="przejdzU('bluza,WoT',239)">Kup produkt</button>
						</div>
					</div>
				</section>
			</article>
